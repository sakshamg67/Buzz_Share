package com.pollinators.buzzshare.LoginReg;
...
import com.pollinators.buzzshare.ForgotPassword.ForgotPassActivity;
...
public class LoginActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(getApplicationContext(),"your Email and password may be incorrect",Toast.LENGTH_LONG).show();
    ...
    private void checkVerifiedEmail() {
        ...
        if (isVerified){
            ...
            Intent intent = new Intent(LoginActivity.this, ChatModuleMain.class);
