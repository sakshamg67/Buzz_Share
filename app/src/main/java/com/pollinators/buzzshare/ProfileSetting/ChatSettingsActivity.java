package com.pollinators.buzzshare.ProfileSetting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent statusUpdateIntent = new Intent(ChatSettingsActivity.this, StatusUpdateActivity.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            new Timer().schedule(new TimerTask(){
                                public void run() {
                                    ChatSettingsActivity.this.runOnUiThread(new Runnable() {
                                        public void run() {
...
//                            SweetToastst.error(ChatSettingsActivity.this, "Profile Photo Error: " + task.getException().getMessage());
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Task<Uri> thumbUriTask = thumb_uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                                    if (!task.isSuccessful()){
//                                        SweetToast.error(ChatSettingsActivity.this, "Thumb Image Error: " + task.getException().getMessage());
                                    }
                ...
                // handling more event
//                SweetToast.info(ChatSettingsActivity.this,"Image cropping failed.");
            }
        }
