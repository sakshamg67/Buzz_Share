package com.pollinators.buzzshare.WelcomeSlide;
...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.getInt("INTRO", 0) == 1){
            startActivity(new Intent(IntroActivity.this, ChatModuleMain.class));
            finish();
        }
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(this, ChatModuleMain.class));
        finish();
    }
